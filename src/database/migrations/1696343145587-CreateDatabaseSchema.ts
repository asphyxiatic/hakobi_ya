...
export class CreateDatabaseSchema1696343145587 implements MigrationInterface {
    name = 'CreateDatabaseSchema1696343145587'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('super-admin', 'admin', 'regular')`);
