...
export class CreateDatabaseSchema1696445672652 implements MigrationInterface {
    name = 'CreateDatabaseSchema1696445672652'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "streets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "owner_id" uuid NOT NULL, CONSTRAINT "UQ_8938e31fae7c4d172fb12726181" UNIQUE ("name"), CONSTRAINT "PK_e375a3a3ebbc18cf91e72374d94" PRIMARY KEY ("id"))`);
